...
//		Sale sale = saleUseCase.findByNumber("#2");
//		System.out.println(sale.getCashier().getCashierName());
//		System.out.println(sale.getSaleNumber());
//		System.out.println(sale.getTransDate());
//		System.out.println(sale.getSaleItems().get(0).getPrice());
//		System.out.println(sale.getSaleItems().get(1).getPrice());		
