...
import com.kkm.pos2.repository.impl.CashierRepositoryDummy;
...
import com.kkm.pos2.repository.impl.SaleItemRepositoryDummy;
...
public class ProcessSaleUseCase {
	...
	public ProcessSaleUseCase() {
		...
		cashierRepository = new CashierRepositoryDummy();
		saleItemRepository = new SaleItemRepositoryDummy();
	}
